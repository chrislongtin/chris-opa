...
<p>
<cf:GetPhrase phrase_id = "41" lang_id = "${lang}"/><c:forEach var = "row" items = "${cfp_criteria.rows}">
    <form action = "<c:url value='index.jsp'>
<c:param name='fuseaction' value='act_cfp_criteria'/>
<c:param name='${user}'/>
</c:url>" method = "post">
        <input type = "hidden" name = "cfp_code" value = "<c:out value='${row.cfp_code}'/>">
        ...
        <input type = "text" name = "cfp_low_rank" size = "10" value = "<c:out value='${row.cfp_low_rank}'/>"> <b>*

        <cf:GetPhrase phrase_id = "141" lang_id = "${lang}"/>:</b>
        <input type = "text" name = "cfp_high_rank" size = "10" value = "<c:out value='${row.cfp_high_rank}'/>">
