...
<p><h2><cf:GetPhrase phrase_id="5" lang_id="${lang}"/></h2>

<c:if test="${user == 'coordinator'}">
<p><a STYLE="text-decoration: underline"  href="index.jsp?fuseaction=modify_cfp&act=add&coordinator"><cf:GetPhrase phrase_id="148" lang_id="${lang}"/></a>
</c:if>

<p><b><cf:GetPhrase phrase_id="1020" lang_id="${lang}" />:&nbsp;&nbsp;&nbsp;<c:out value="${cur_reccount}" />
<br><cf:GetPhrase phrase_id="1021" lang_id="${lang}" />:&nbsp;&nbsp;&nbsp;<c:out value="${arc_reccount}" /></b></p>
<br>
<!--
...
<tr>
	...
	<td colspan="3" bgcolor="EAEAEA"><c:out value="${job_name}" /> </td>
	...
	<td colspan="3" bgcolor="EAEAEA"><c:out value="${job_length}" /> </td>
    </td></tr>
</table> 
 -->
<!--
...
<p>
<c:choose>
<c:when test="${user == 'coordinator'}"><cf:GetPhrase phrase_id="150" lang_id="${lang}"/></c:when>
<c:otherwise>
...
<tr bgcolor="D2D2D2">
	<td colspan="6" align="center"><font face="Arial"><b><cf:GetPhrase phrase_id="85" lang_id="${lang}"/></b></td>

</tr><tr bgcolor="E8E8E8">
	<td><font face="Arial" size="-1"><b><cf:GetPhrase phrase_id="151" lang_id="${lang}"/></b></td>
	<td><font face="Arial" size="-1"><center><b><cf:GetPhrase phrase_id="78" lang_id="${lang}"/></b></td>
	<td><font face="Arial" size="-1"><center><b><cf:GetPhrase phrase_id="79" lang_id="${lang}"/></b></td>
	<td><font face="Arial" size="-1"><center><b><cf:GetPhrase phrase_id="56" lang_id="${lang}"/></b></td>
...
<tr>
	<td><font face="Arial" size="-1"><p><a STYLE="text-decoration: underline"  href="<c:url value='index.jsp'>
<c:param name='fuseaction' value='show_cfp'/>
<c:param name='cfp_code' value='${row.cfp_code}'/>
<c:param name='job_name' value='${row.cfp_title}'/>
<c:param name='${user}'/>
</c:url>"><c:out value="${row.cfp_title}"/></a></td>
	<td><font face="Arial" size="-1"><center><fmt:formatDate value="${row.cfp_startdate}" pattern="dd-MMM-yyyy"/></td>
	<td><font face="Arial" size="-1"><center><fmt:formatDate value="${row.cfp_deadline}" pattern="dd-MMM-yyyy"/></td>
	<td><font face="Arial" size="-1"><center>CFP-<c:out value="${row.cfp_code}"/></td>
	<!--<td align="RIGHT"><font face="Arial" size="-1"><cf:ParagraphFormat value="${row.cfp_focus}" /></td> -->
...
<tr bgcolor="D2D2D2">
	<td colspan="6" align="center"><font face="Arial"><b><cf:GetPhrase phrase_id="152" lang_id="${lang}"/></b></td>
...
<tr>
	<td><font face="Arial" size="-1"><a STYLE="text-decoration: underline"  href="<c:url value='index.jsp'>
<c:param name='fuseaction' value='show_cfp'/>
<c:param name='cfp_code' value='${row.cfp_code}'/>
