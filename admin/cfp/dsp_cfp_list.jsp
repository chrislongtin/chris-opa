...
<sql:query var = "CFP_archived_list">
    ...
    <table width = "600" border = "1" cellspacing = "0" cellpadding = "5">
        ...
        <c:forEach var = "row" items = "${CFP_current_list.rows}">
            <tr>
                <td><font face = "Arial"
                          size = "-1"><p><a STYLE = "text-decoration: underline"
...
<c:param name='${user}'/>
                    ...
                    <c:out value = "${row.cfp_title}"/></a></td>

                <td><font face = "Arial" size = "-1"><center>
                ...
                <td><font face = "Arial" size = "-1"><center>CFP-

                        <c:out value = "${row.cfp_code}"/></td>
