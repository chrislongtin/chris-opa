...
<sql:update var = "doc_add">
    insert into admin_documents (doc_id, tracking_code, doc_type_id, doc_title, doc_filename, doc_date) values ( ?, 0,
    0, ?, ?, ? )
...
<c:if test = "${!empty discuss_message}">
    ...
    <sql:update var = "message_add">
        insert into admin_discussion (discussion_id, doc_id, discuss_level, discuss_parent, discuss_subject,
        discuss_date, discuss_message
