...
%>
        ...
        <c:if test = "${act=='delete'}">
            ...
            <sql:query var = "isreport">
                select d.doc_type_id,dt.doc_type_category from documents d, document_types dt where d.doc_id = ? and
            ...
            <c:if test = "${isreport.rows[0].doc_type_category == 'R'}">
                <sql:update>
                    update reviewer_assignment set report_review_completed = 0 where tracking_code = ?
