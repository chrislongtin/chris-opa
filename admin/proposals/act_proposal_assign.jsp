                ...
                <c:otherwise>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <sql:update>
                                insert into reviewer_assignment ( assignment_id, reviewer_id, cfp_code, tracking_code,
                                report, proposal ) values ( ?, ?, ?, ?, ?, ? )
                            ...
                            <c:set var = "reviewer_email" value = "${reviewers_email.rows[0].reviewer_email}"
                                   scope = "page"/>
