...
<br>
<a STYLE="text-decoration: underline"  href = "../docs/<c:out value="${param.doc_filename}" />?ois=no" target = "new">

<c:out value = "${param.doc_filename}"/></a><c:if test = "${param.act == 'add'}">
    <form action = "<c:url value='index.jsp'>
     <c:param name='fuseaction' value='act_report_review'/>
     </c:url>" method = "post">
        <input type = "hidden" name = "act" value = "add">
        <input type = "hidden" name = "tracking_code" value = "<c:out value="${param.tracking_code}" />">
        <input type = "hidden" name = "doc_id" value = "<c:out value="${param.doc_id}" />">
        <input type = "hidden" name = "proposal_title" value = "<c:out value="${param.proposal_title}" />">
        <input type = "hidden" name = "doc_title" value = "<c:out value="${param.doc_title}" />">
