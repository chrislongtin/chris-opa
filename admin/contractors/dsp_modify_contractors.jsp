...
<c:choose>
    ...
    <c:when test = "${act=='edit'}">
		...
		<p><b><cf:GetPhrase phrase_id="1037" lang_id="${lang}" />:</b>	
		<br><input type="date"  size="10" name="next_status_update_date" value="<fmt:formatDate value='${er.next_status_update_date}' pattern='MMM-dd-yyyy'/>">
		<br><p><input type="submit" value=" <cf:GetPhrase phrase_id="456" lang_id="${lang}" /> ">
		</form>
