...
<%
    class GuardRequiredParams
        ...
        boolean isParameterMissed()
            ...
            for (Iterator it = params.entrySet().iterator(); it.hasNext(); )
                ...
                if (paramname.endsWith("_required"))
                    {
                    String reqname = paramname.substring(0, paramname.length()
                                                                - 9);
        ...
        String getSplashScreen()
            ...
            if (missed == null)
                throw
                    new JspException("GuardRequiredParams::isParameterMissed() method never called.");
            ...
            <html>
                ...
                <body>
                    <table border = "1"            cellpadding = "3"
                           bordercolor = "#000808" bgcolor = "#e7e7e7">
                        <tr>
                            <td>
                                <table cellpadding = "0" cellspacing = "0"
                                    ...
                                    <tr>
                                        <td id = "tableProps2" align = "left"
                                            valign = "middle">
                                            <h1 id = "textSection1"
                                            style = "COLOR: black; FONT: 13pt/15pt verdana"> Form entries incomplete or invalid. </h1>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td id = "tablePropsWidth"
                                            colspan = "2">
                                        ...
                                        %>
                                                    ...
                                                    <li>A value must be
                                                    entered for
                                                    the <%= reqfield.toUpperCase() %> field.
                                        ...
                                        %>
                                            ...
                                            href = "javascript: history.back()">back</a> and correct the problem. </font>
                                        </td>
                                    </tr>
                                </table>
                            </td>
